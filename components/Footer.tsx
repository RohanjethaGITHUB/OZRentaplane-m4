    ...
    <footer className="bg-mkt-main pt-24 pb-12 px-6 md:px-12 lg:px-20 border-t border-white/5">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 md:gap-8 mb-24">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-x-16 lg:gap-x-24 gap-y-12">
          ...
          <div className="flex flex-col gap-[0.85rem]">
            ...
            <a href="/fleet" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Cessna 172</a>
          </div>

          {/* Column 2 */}
          <div className="flex flex-col gap-[0.85rem]">
            <h4 className="font-sans font-bold text-[0.85rem] text-[#dbeafe] mb-1">Company</h4>
            <a href="#" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Our Story</a>
            <a href="#" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Safety Protocols</a>
            <a href="#" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Careers</a>
          </div>
          ...
          <div className="flex flex-col gap-[0.85rem]">
            ...
            <a href="/terms-and-conditions" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Terms &amp; Conditions</a>
            <a href="/privacy-policy" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Privacy Policy</a>
            <a href="/safety-disclaimer" className="font-sans text-[0.8rem] text-[#c4c6cf] hover:text-[#E0B13B] transition-colors opacity-70">Safety Disclaimer</a>
          </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-white/[0.06]">
        ...
        <div className="flex gap-7 items-center text-[#c4c6cf] opacity-60">
          <a href="#" aria-label="Region" className="hover:opacity-100 hover:text-[#E0B13B] transition-colors">
          ...
          <a href="#" aria-label="Social" className="hover:opacity-100 hover:text-[#E0B13B] transition-colors">
            <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
