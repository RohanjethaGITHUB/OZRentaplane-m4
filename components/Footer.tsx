  ...
  return (
    <footer className="bg-[#0a1426] pt-24 pb-12 px-6 md:px-12 lg:px-20" style={{ marginTop: '-2px' }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 md:gap-8 mb-24">
        ...
        {/* Left Brand Area */}
        <div className="max-w-xs shrink-0 bg-transparent">
          <img
            src="/Logo/ozrentaplane-transparent-bg.png"
            alt="OZ Rent A Plane"
            className="h-10 w-auto object-contain mb-5 bg-transparent"
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-x-16 lg:gap-x-24 gap-y-12">
          ...
          <div className="flex flex-col gap-[0.85rem]">
            ...
            <a href="#" className="font-sans text-[0.8rem] text-cloud-muted hover:text-ember-gold transition-colors opacity-70">Our Story</a>
            <a href="#" className="font-sans text-[0.8rem] text-cloud-muted hover:text-ember-gold transition-colors opacity-70">Safety Protocols</a>
            <a href="#" className="font-sans text-[0.8rem] text-cloud-muted hover:text-ember-gold transition-colors opacity-70">Careers</a>
          </div>

          {/* Column 3 */}
          <div className="flex flex-col gap-[0.85rem]">
            <h4 className="font-sans font-bold text-[0.85rem] text-horizon-border mb-1">Support</h4>
            <a href="#" className="font-sans text-[0.8rem] text-cloud-muted hover:text-ember-gold transition-colors opacity-70">Help Center</a>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-white/[0.06]">
        ...
        <div className="flex gap-7 items-center text-cloud-muted opacity-60">
          <a href="#" aria-label="Region" className="hover:opacity-100 hover:text-ember-gold transition-colors">
          ...
          <a href="#" aria-label="Social" className="hover:opacity-100 hover:text-ember-gold transition-colors">
            <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
