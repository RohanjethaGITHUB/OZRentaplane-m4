/**
 * Shared admin queue-list skeleton used by route loading.tsx files.
 * Instant click-to-skeleton wrappers were removed — they unmounted live
 * pages and hurt navigation performance.
 */
