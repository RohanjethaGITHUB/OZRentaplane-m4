    ...
    <div className="min-h-screen bg-white text-[#0f172a] font-sans antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="relative min-h-[620px] sm:min-h-[660px] lg:min-h-[720px] w-full overflow-hidden flex items-center bg-[#f4f8fd]">
        ...
        <div className="max-w-[1400px] mx-auto w-full px-6 sm:px-10 lg:px-16 pt-[120px] pb-14 lg:pt-[130px] lg:pb-18 relative z-10">
          <StaggerContainer className="max-w-xl" staggerDelay={0.16} viewportMargin="-40px">
      ...
      <section className="py-10 sm:py-14 lg:py-20 bg-[#f8fbff] relative overflow-hidden">
        ...
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          {/* Header */}
          <StaggerContainer className="text-center max-w-2xl mx-auto mb-8 sm:mb-12 lg:mb-14 relative" staggerDelay={0.16} viewportMargin="-60px">
          ...
          <StaggerContainer className="flex flex-col lg:flex-row items-center justify-between gap-4 xl:gap-5" staggerDelay={0.18} viewportMargin="-60px">
            {/* Step 1: Request */}
            <StaggerItem duration={1.1} className="w-full flex-1 max-w-[320px] lg:max-w-[270px]">
              <HoverEmphasize hoverY={-4}>
                <div className="relative bg-white rounded-2xl p-5 sm:p-6 pb-6 border border-blue-100/90 shadow-[0_4px_24px_rgba(0,0,0,0.03)] hover:shadow-md transition-all duration-200 flex flex-col items-center text-center group w-full min-h-0 lg:min-h-[250px]">
      ...
      <section className="relative bg-white overflow-hidden min-h-[380px] sm:min-h-[400px] lg:min-h-[420px] flex items-center">
        ...
        <div className="max-w-[1400px] mx-auto w-full px-6 sm:px-10 lg:px-16 py-8 lg:py-10 relative z-10">
          <StaggerContainer className="max-w-lg lg:max-w-[420px]" staggerDelay={0.14} viewportMargin="-60px">
        ...
        <FadeUp delay={0.25} duration={1.0} className="hidden sm:flex absolute bottom-10 sm:bottom-12 lg:bottom-14 xl:bottom-16 right-6 lg:right-10 xl:right-14 z-20 max-w-[280px] sm:max-w-[290px]">
          <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3.5 sm:p-4 border border-white/80 shadow-[0_8px_25px_rgba(15,23,42,0.1)] flex items-start gap-3 w-full">
      ...
      <section className="bg-[#f8fafc] relative overflow-hidden border-t border-slate-200/60 flex flex-col lg:flex-row items-stretch">
        ...
        <div className="flex-1 py-8 sm:py-12 lg:py-16 px-5 sm:px-10 lg:pl-16 lg:pr-10 flex flex-col justify-center">
          <StaggerContainer staggerDelay={0.16} viewportMargin="-60px">
            <StaggerItem duration={1.0}>
        ...
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 xl:gap-20 items-start">
            ...
            <div className="lg:col-span-9 flex flex-col justify-between">
              ...
              <StaggerContainer className="mb-6 sm:mb-7 text-center" staggerDelay={0.16} viewportMargin="-60px">
                <StaggerItem duration={1.0}>
              ...
              <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-5" staggerDelay={0.16} viewportMargin="-60px">
                {/* Card 1: James R. */}
                <StaggerItem duration={1.1}>
                  <HoverEmphasize hoverY={-4}>
                    <div className="bg-white rounded-2xl p-6 border border-blue-100/90 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-md transition-all flex flex-col justify-between h-full">
                      <div>
            ...
            <div className="lg:col-span-3 flex flex-col items-center justify-start text-center pt-0.5">
              <StaggerContainer className="w-full flex flex-col items-center" staggerDelay={0.14} viewportMargin="-60px">
                <StaggerItem duration={1.0}>
                ...
                <div className="space-y-4 sm:space-y-5 w-full flex flex-col items-center justify-center">
                  {/* AOPA Australia */}
                  <StaggerItem duration={1.1} className="w-full flex items-center justify-center">
                    <HoverEmphasize hoverScale={1.04}>
                      <img
