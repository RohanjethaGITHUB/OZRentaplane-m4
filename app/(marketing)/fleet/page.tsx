    ...
    <main className="min-h-screen bg-[#091421] text-[#d9e3f6]">
      ...
      <section className="relative py-32 bg-[#0c1827] border-t border-white/5">
        <div className="px-6 md:px-12 lg:px-20 max-w-5xl mx-auto text-center">
          <FadeUp duration={2.2} viewportMargin="-25%">
            <h2 className="font-serif text-4xl md:text-5xl font-normal tracking-tight text-[#d9e3f6] mb-24">
              The Path to Command
            </h2>
          </FadeUp>
          
          <StaggerContainer className="relative flex flex-col md:flex-row justify-between items-start space-y-16 md:space-y-0 max-w-4xl mx-auto" staggerDelay={0.8} viewportMargin="-25%">
            ...
            {/* Step 1 */}
            <StaggerItem duration={2.4} className="relative z-10 flex flex-col items-center flex-1">
      ...
      <section className="relative pt-24 pb-32 border-t border-white/5 text-center flex items-center justify-center min-h-[500px]">
        ...
        />
        {/* Dark overlay: dense enough to keep premium feel and legibility, light enough to see TwilightFlight */}
