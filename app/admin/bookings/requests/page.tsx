  ...
  return (
    <>
      <AdminPortalHero
        ...
        subtitle="Review checkout flights and standard aircraft booking requests."
      />
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-10 pb-24">
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-5 mb-8 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Link href="/admin/bookings/requests" className={filterLinkClass('all')}>
              All
            </Link>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {checkoutTabs.map(tab => (
                <Link key={tab.value} href={`/admin/bookings/requests?status=${tab.value}`} className={filterLinkClass(tab.value)}>
                  {tab.label}
                </Link>
              ))}
            </div>
