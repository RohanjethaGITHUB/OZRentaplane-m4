...
export default async function AdminBookingsOverviewPage() {
  ...
  const heroActions = (
    <>
      <Link href="/admin/calendar" className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-full text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2 border border-white/10">
        <span className="material-symbols-outlined text-sm">calendar_month</span> Calendar
      </Link>
      <Link href="/admin/bookings/checkout" className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-full text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2 border border-white/10">
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <StatCard 
          ...
          href="/admin/bookings/post-flight"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#1e2023]/60 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
          <div className="px-6 py-5 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
            ...
            <Link href="/admin/bookings/checkout" className="text-[10px] text-slate-500 hover:text-blue-300 uppercase tracking-widest font-bold">View Queue →</Link>
          </div>
