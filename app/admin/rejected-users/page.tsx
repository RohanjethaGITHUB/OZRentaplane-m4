  ...
  return (
    <div className="p-10 max-w-7xl">
      <header className="mb-12">
        <h2 className="font-serif text-4xl font-light text-[#e2e2e6] tracking-tight">Rejected Users</h2>
        <p className="text-slate-400 mt-2 font-light tracking-wide">Customers whose verification was not approved</p>
