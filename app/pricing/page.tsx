  ...
  return (
    <main className="bg-[#091421] text-[#d9e3f6] overflow-x-hidden">
      ...
      <section className="relative px-6 md:px-12 lg:px-20 overflow-hidden min-h-[500px] md:min-h-[750px] flex items-center">
        ...
        />
        <div className="absolute inset-0 z-0 bg-gradient-to-r from-[#091421] via-[#091421]/85 to-[#091421]/40" />
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#091421]/60 via-transparent to-[#091421]/70" />
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 -mt-16 relative z-20 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Casual Hourly */}
          <div className="bg-[#0c1827] p-10 rounded-xl flex flex-col h-full border border-white/5 hover:bg-[#111e30] transition-colors duration-500">
            <span className="font-sans font-semibold uppercase tracking-[0.25em] text-[0.65rem] text-[#64748b] mb-4">On-Demand</span>
            <h3 className="font-serif text-3xl font-normal text-[#d9e3f6] mb-6">Casual Hourly Rate</h3>
            <div className="mb-8">
            ...
            <div className="mt-auto">
              <button className="w-full font-sans font-bold text-[0.8rem] tracking-widest uppercase py-4 rounded border border-white/20 text-[#c4c6cf] hover:bg-white/5 transition-colors">
                Select Plan
              </button>
            </div>
          </div>
          ...
          {/* 10 Hour Package */}
          <div className="bg-[#0c1827] p-10 rounded-xl flex flex-col h-full border border-[#aec7f7]/20 shadow-[0_20px_40px_rgba(0,0,0,0.3)] relative overflow-hidden hover:bg-[#111e30] transition-colors duration-500">
            <div className="absolute top-0 right-0 bg-[#aec7f7]/10 px-4 py-1 text-[10px] uppercase tracking-widest text-[#aec7f7] border-b border-l border-[#aec7f7]/20 font-sans font-semibold">
              Standard
            </div>
            <span className="font-sans font-semibold uppercase tracking-[0.25em] text-[0.65rem] text-[#64748b] mb-4">The Weekend Flyer</span>
            <h3 className="font-serif text-3xl font-normal text-[#d9e3f6] mb-6">10 Hour Package</h3>
            <div className="mb-8">
            ...
            <div className="flex items-center gap-2 mb-8 text-[#94a3b8]">
              ...
              <span className="font-sans text-[0.85rem]">$300 effective hourly rate</span>
            </div>
            <p className="text-[#94a3b8] font-sans mb-8 text-[0.85rem] leading-relaxed">
              Balanced flexibility for those who aim to fly regularly while maintaining a budget.
            </p>
            <div className="mt-auto">
              <button className="w-full font-sans font-bold text-[0.8rem] tracking-widest uppercase py-4 rounded border border-[#aec7f7]/30 text-[#aec7f7] hover:bg-[#aec7f7]/10 transition-colors">
                Select Plan
              </button>
            </div>
          </div>
          ...
          {/* 30 Hour Package */}
          <div className="bg-[#0c1827] p-10 rounded-xl flex flex-col h-full border border-[#aec7f7]/30 relative shadow-2xl overflow-hidden">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#aec7f7] text-[#143057] px-6 py-1.5 rounded-full text-[10px] font-sans font-bold uppercase tracking-widest whitespace-nowrap">
              Best Value
            </div>
            <span className="font-sans font-semibold uppercase tracking-[0.25em] text-[0.65rem] text-[#aec7f7] mb-4">Atmospheric Navigator</span>
            <h3 className="font-serif text-3xl font-normal text-[#d9e3f6] mb-6">30 Hour Package</h3>
            <div className="mb-8">
            ...
            <div className="flex flex-col gap-3 mb-8">
              <div className="flex items-center gap-2 text-[#aec7f7]">
                ...
                <span className="font-sans font-semibold text-[0.85rem]">$280 effective hourly rate</span>
              </div>
              <div className="flex items-center gap-2 text-[#94a3b8]">
                <Icon name="savings" className="text-sm" />
                <span className="font-sans text-[0.85rem]">Save $1,200 over casual rates</span>
              </div>
            </div>
            <p className="text-[#94a3b8] font-sans mb-8 text-[0.85rem] leading-relaxed">
            ...
            <div className="mt-auto">
              <button className="w-full inline-block bg-gradient-to-r from-[#aec7f7] to-[#1b365d] text-[#143057] rounded-md font-sans font-bold tracking-widest uppercase text-[0.8rem] py-4 shadow-lg transition-all active:scale-95 hover:brightness-110">
                Select Best Value
              </button>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="bg-[#0c1827] border-y border-white/5 py-8 px-8 md:px-12 rounded-lg">
      ...
      <section className="py-32 max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={title} className="bg-[#0c1827] p-8 rounded-xl border border-white/5 hover:bg-[#111e30] transition-colors">
          ...
          {/* Not Included */}
          <div className="lg:col-span-5 bg-[#0c1827] p-10 rounded-xl border border-white/5">
            <p className="font-sans font-semibold uppercase tracking-[0.25em] text-[0.65rem] text-[#64748b] mb-4">
              Additional Costs
            </p>
            <h2 className="font-serif text-3xl font-normal text-[#d9e3f6] mb-6">Not Included</h2>
            <p className="text-[#94a3b8] mb-10 text-[0.85rem] font-sans leading-relaxed">
              To ensure maximum transparency, please note the following operational costs are
              handled separately:
            </p>
            <ul className="space-y-6">
              {[
                { title: 'Fuel (Wet Rate Adjustments)', body: 'Billed based on actual consumption at current FBO market rates.' },
                { title: 'Landing & Hangarage Fees',    body: 'External airport fees incurred during your itinerary are your responsibility.' },
                { title: 'Instructor Fees',             body: 'Checkout flights or instructional hours are billed separately per session.' },
              ].map(({ title, body }) => (
                <li key={title} className="flex items-start gap-4">
                  <Icon name="remove_circle" className="text-[#94a3b8] mt-0.5 shrink-0" />
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={title} className="text-center group">
                <div className="w-20 h-20 bg-[#0c1827] mx-auto rounded-full flex items-center justify-center mb-8 border border-white/5 group-hover:border-[#aec7f7]/40 transition-colors">
                  <Icon name={icon} className="text-[#aec7f7]" style={{ fontSize: '32px' }} />
                </div>
      ...
      <section className="border-t border-white/5 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-32 grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        {/* Eligibility card */}
        <div className="p-12 rounded-xl flex flex-col justify-center border border-white/5 relative overflow-hidden">
          <div
          ...
          <div className="relative z-10">
            ...
            <a
              href="/pilotRequirements"
              className="inline-block font-sans font-bold text-[0.8rem] tracking-widest uppercase px-8 py-4 rounded border border-white/20 text-[#c4c6cf] hover:bg-white/5 transition-colors"
            >
