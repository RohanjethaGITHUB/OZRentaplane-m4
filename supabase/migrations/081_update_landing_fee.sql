...
-- Update persisted landing charge defaults from $25.00 to $28.95.
UPDATE public.airports_landing_charges
SET landing_fee_cents = 2895
WHERE landing_fee_cents = 2500;

-- Redefine function lineage that previously hardcoded 2500-cent landing fee.
-- Source migrations reviewed: 045, 046, 047, 049, 050.
-- Current effective standard-billing function comes from migration 050.
