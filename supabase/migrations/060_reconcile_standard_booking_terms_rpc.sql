-- Reconcile create_aircraft_booking_atomic in environments where an older
-- terms-enforcing overload is still active.
--
-- This keeps backward-compatible terms params in the signature, but makes
-- them no-op for standard bookings.
